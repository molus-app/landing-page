  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-md mx-auto">
      <div className="flex border-2 border-black dark:border-white rounded-lg overflow-hidden">
        ...
        <button 
          type="submit" 
          className="px-4 bg-white dark:bg-gray-800 border-l-2 border-black dark:border-white font-indie text-xl hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white"
        >
          ▶
        </button>
      </div>
